<?php
/* Template Name: Personalize Sweatshirt */
get_header(); 
?>
<main class="bg-[#161D0D]">
<div class="max-w-screen-lg mx-auto sm:px-6 flex flex-col gap-6 p-4">

    <h1 class="text-center my-8 text-4xl md:text-5xl font-extrabold text-[#FEFAE0] transition-all duration-300 hover:scale-110 hover:text-[#D58F3E]">شخصی‌سازی دورس</h1>
    ...
    <div class="flex flex-col md:flex-row gap-4 md:gap-6 justify-between">
        ...
        <div class="flex flex-col flex-1 text-[#EDE0D4]">
            <label class="mb-1 font-semibold">مدل دورس</label>
            <select id="product-model" class="border rounded px-3 py-2 bg-[#A15F13] text-[#EDE0D4]">
                ...
                <option value="یقه دار">یقه دار</option>
                <option class="زیپ دار">زیپ دار</option>
                <option class="یقه اسکی">یقه اسکی</option>
            </select>
        </div>
    ...
    <div class="relative w-fit h-fit md:h-fit border rounded overflow-hidden mt-4 touch-none mx-auto">
        <?php echo do_shortcode('[3d_viewer id="410"]'); ?>
...
// ارسال به سبد خرید
    document.getElementById('add-to-cart').addEventListener('click', function(){
        ...
        formData.append('action', 'add_custom_sweatshirt_to_cart');
